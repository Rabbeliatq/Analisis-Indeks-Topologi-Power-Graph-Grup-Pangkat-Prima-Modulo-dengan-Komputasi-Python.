# -*- coding: utf-8 -*-
"""
Created on Sat May 17 08:04:17 2025
...
# Maximum k value to prevent excessive computation
MAX_K_VALUE = 5
...
def show_graph_in_tab(parent, G, p, k):
    if G:
        ...
        messagebox.showinfo("Info", "Graph cannot be created for this k value.")
...
# Main GUI setup
window = tk.Tk()
window.title("Power Graph Group Modulo With Topologi Index Analyzer")
...
ttk.Label(header_frame, text="Power Graph Group Modulo With Topologi Index Analyzer", font=FONT_TITLE, 
...
# Index selection with better visual separation
